...
const ProfileCardComponent = ({
  ...
  const handlePointerEnter = useCallback((event) => {
    const shell = shellRef.current;
    if (!shell || !tiltEngine) return;
    rectRef.current = shell.getBoundingClientRect(); // Cache it immediately!
  ...
  return (
    <div ref={wrapRef} className={`pc-card-wrapper ${enableTilt ? 'tilt-enabled' : 'tilt-disabled'} ${className}`.trim()} style={cardStyle}>
                  ...
                  <div className="pc-user-details">
                    <div className="pc-mini-avatar">
                      <img
                        ...
                        loading="lazy"
                        onError={(e) => { e.target.opacity = '0.5'; }}
                      />
                    </div>
