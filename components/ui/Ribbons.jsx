  ...
  useEffect(() => {
    ...
    function update() {
      ...
      lines.forEach((line) => {
        ...
        totalVelocity += line.mouseVelocity.len();
      ...
      // Sleep the requestAnimationFrame if mouse stationary and physics fully decayed
      if (timeSinceMove > 1500 && totalVelocity < 0.005) {
        isSleeping = true;
        return;
      }
